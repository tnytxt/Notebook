#### Linux on MacBookAir 7.2

  

[https://github.com/M4he/Linux/blob/master/Hardware/MacBookAir7%2C2.md](https://github.com/M4he/Linux/blob/master/Hardware/MacBookAir7%2C2.md)
...
- **WARNING**: this script disabled keypress wakeup _except_ for the power button, you may only wake up the device from suspend by pressing the power button!
...
- in contrast to older chips UXA is not an option anymore, it is far too slow/sluggish from my experience, this chip _needs_ SNA to perform
...
- although I've been using this entry without issues, _I do not know whether it is still necessary_
